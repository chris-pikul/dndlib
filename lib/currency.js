 ...
 */
import { positive, randomFloat, isPlainObject, } from './utils';
;
/**
...
export default class Currency {
     ...
     */
    constructor(props = null, usePlatinum = true, useElectrum = false) {
        /**
         ...
         */
        this.add = (value, balanceAfter = false) => {
         ...
         */
        this.subtract = (value, balanceAfter = false) => {
            const obj = new Currency(value);
            if (obj.copper)
                this.copper = (this.copper || 0) - obj.copper;
            if (obj.silver)
         ...
         */
        this.fromGold = (goldValue, usePlatinum = true, useElectrum = false) => {
            let cp = 0;
            let sp = 0;
            let ep = 0;
            let gp = goldValue;
         ...
         */
        this.balance = (usePlatinum = true, useElectrum = false) => {
 ...
 */
Currency.reduce = (value, div = 10) => ([value % div, Math.floor(value / div)]);
