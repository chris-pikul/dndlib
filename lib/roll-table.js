...
import { inPlaceConcat, isPlainObject, testIfPositiveInteger, } from './utils';
import { strictValidateOptionalProp, strictValidatePropsParameter, strictValidateRequiredArrayProp, strictValidateRequiredObjectProp, strictValidateRequiredProp, } from './utils/errors';
;
/**
