 ...
 */
export const enumValues = (enumClass:any):Array<string> => Object.keys(enumClass);
 ...
 */
export const enumValuesToString = (enumClass:any):string => (enumValues(enumClass).join(', '));
