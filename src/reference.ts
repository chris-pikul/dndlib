...
export default class Reference
    implements IReference, IAssignable, IValidatable
{
    /**
    ...
    constructor(props?: any) {
        ...
        if (typeof props !== 'undefined' && props !== null) {
            if (props instanceof Reference) {
                ...
                console.warn(
                    `Attempting to instantiate a Reference object with an invalid parameter. Expected either a Reference object, or a plain JSON Object of properties. Instead encountered a "${typeof props}"`,
                );
            }
        }
    }
    ...
    validateSync = (): ValidationErrors => {
        ...
        if (this.type === ResourceType.UNKNOWN) {
            errs.push(
                `${clsName}.type should not be "UNKNOWN", and instead should be a valid ResourceType enumeration.`,
            );
        }
